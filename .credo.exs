  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Design.TagFIXME, [priority: :medium, exit_status: 0]},
        ...
        # {Credo.Check.Readability.PredicateFunctionNames, []}, # we have to disable this to define Matcha.Context.Trace.is_seq_trace/0
